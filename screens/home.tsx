  ...
  return (
    <ScrollView style={homeStyles.app} showsVerticalScrollIndicator={false} >
      <View style={homeStyles.outerContainer}>
          ...
          <Pressable onPress={ () => navigation.navigate('ButteryScreen', { college_Name: 'Branford', header_Color: '#FFF'})}><Card backgroundImage={require('../assets/gradient_backgrounds/blue-to-green.png')} college='Branford' openTime='10:00pm' closeTime='1:00am' image={require('../assets/images/collegeIcons/branford.png')}/></Pressable>
