  ...
  return (
    <ScrollView style={home.app} showsVerticalScrollIndicator={false} >
      <View style={home.outerContainer}>
          <Card onPress={ () => navigation.navigate('ButteryScreen', { college_Name: 'Berkeley', header_Color: '#FFF'})} backgroundImage={require('../assets/gradient_backgrounds/red-to-pink.png')} college='Berkeley' openTime='20:00' closeTime='11:59pm' image={require('../assets/images/collegeIcons/berkeley.png')} />
          ...
          <Card onPress={ () => navigation.navigate('ButteryScreen', { college_Name: 'Davenport', header_Color: '#FFF'})} backgroundImage={require('../assets/gradient_backgrounds/black-to-grey.png')} college='Davenport' openTime='7:00' closeTime='2:00am' image={require('../assets/images/collegeIcons/davenport.png')}/>
