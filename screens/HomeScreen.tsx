  ...
  return (
    <ScrollView style={home.app} showsVerticalScrollIndicator={false} >
      <View style={home.outerContainer}>
          <Card onPress={ () => navigation.navigate('ButteryScreen', { college_Name: 'Berkeley', header_Color: '#FFF'})} backgroundImage={require('../assets/gradient_backgrounds/red-to-pink.png')} college='Berkeley' openTime='00:00' closeTime='11:59pm' image={require('../assets/images/collegeIcons/berkeley.png')} />
